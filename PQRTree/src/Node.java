...
public abstract class Node {
	...
	public PQRNode getParent() {
		if (this.representant == this) return parent;
		else return this.find().getParent();
	}

	public void setColor(Color color) {
		this.color = color;
		
		if (color == Color.GRAY) this.getParent().addGrayChild(this);
		if (color == Color.BLACK) this.getParent().addBlackChild(this);
	}
